          ...
          <div className="space-y-5 lg:col-span-1">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-white/25 text-[9px] tracking-[0.2em] uppercase">Premium Darjeeling Tea</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 pt-2">
              <a href="https://wa.me/917811081552" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/5 hover:bg-green-600/20 border border-white/10 hover:border-green-400/30 flex items-center justify-center text-white/50 hover:text-green-400 transition-all" aria-label="WhatsApp">
