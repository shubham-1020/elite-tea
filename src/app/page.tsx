          ...
          <FadeIn direction="up">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a
                ...
                id="cta-whatsapp-btn"
                className="flex items-center gap-2 bg-green-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-green-700 transition-all transform hover:scale-105 shadow-xl"
              >
